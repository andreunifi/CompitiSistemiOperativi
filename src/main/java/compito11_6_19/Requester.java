        ...
        try {
            ...
            while (true){
                if(iswaiting){
                    ...
                    //FIXME iswaiting è sempre true anche dopo che il worker ha preso in carico la richiesta,
                    //FIXME l'ha eseguita e ha settato iswaiting=false tramite la reference a questo thread.
